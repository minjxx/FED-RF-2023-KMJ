        ...
        <React.Fragment>
            ...
            <section>
                ...
                <div className="img-box">
                    <img src={dataNum ? "./images/gallery/hyo.jpg" : "./images/vans/gongyoo.jpg"} alt={dataNum ? "엘레강스한 효진" : "멋진공유"} />
                </div>
            </section>
            {/* 3. 데이터 변경 버튼 */}
...
function GoodsCode(props) {
    ...
    return selData.map((v) => (
        ...
        <a href="#" onClick={()=>{props.chgFn(1,v.idx)}}>
            <ol class="glist">
                <li>
                    <img src={props.idx ? "./images/gallery/" + v.idx + ".jpg" : "./images/vans/vans_" + v.idx + ".jpg"} alt={props.idx ? "드레스" : "신발"} />
                </li>
                <li>{v.gname}</li>
                <li>가격 : {v.gprice}원</li>
            </ol>
...
function SubViewCode(props) {
    ...
    return (
        <ol style={{display:'flex',listStyle:'none'}}>
            <li>
                <img src={props.idx ? "./images/gallery/" + selItem.idx + ".jpg" : "./images/vans/vans_" + selItem.idx + ".jpg"} alt={props.idx ? "드레스" : "신발"} />
            </li>
